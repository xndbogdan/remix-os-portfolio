...
export const Projects = () => {
  return (
    <div className="bg-white p-2 overflow-y-auto border border-black text-sm max-h-80 select-full">
      ...
      <p className="mt-2"><a className="text-blue-700 hover:text-blue-700" target="_blank" href="https://www.artmark.ro/" rel="noreferrer">• A10 by Artmark</a> - Website</p>
      <div className="my-1">
      ...
      <p className="mt-2"><a className="text-blue-700 hover:text-blue-700" target="_blank" href="https://www.artsafari.ro/" rel="noreferrer">• Art Safari</a> - Website</p>
      <div className="my-1">
        <a className="bg-gray-700 text-xs rounded-md p-1 text-white">~70k visits per month</a>
      </div>
