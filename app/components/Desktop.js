                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="max-w-4xl mx-auto">
                            <div className="flex flex-wrap justify-center md:justify-between items-start">
                                ...
                                <Draggable handle=".handle" onMouseDown={this.toggleWindowVisibility}>
                                    <div id='window-4' className="p-1 border border-black mt-4 bg-gray-mac shadow-mac-os os-window w-full max-w-sm pointer-events-auto" style={this.state.windows[4].focused ? {zIndex: 99} : {zIndex:1}}>
                                        <div className="flex flex-row items-center pb-1">
                                            <div className="close-btn h-4 w-4 border border-black mr-2 hover:invert hover:bg-white cursor-point"></div>
                                            <div className="flex-1 flex handle h-4 items-center">
                                                <div className="flex-1 flex flex-col justify-between cursor-grab h-2">
                                ...
                                <Draggable handle=".handle" onMouseDown={this.toggleWindowVisibility}>
                                    <div id='window-5' className="p-1 border border-black mt-4 bg-gray-mac shadow-mac-os os-window w-full mb-16 max-w-sm pointer-events-auto" style={this.state.windows[5].focused ? {zIndex: 99} : {zIndex:1}}>
                                        <div className="flex flex-row items-center pb-1">
                                            <div className="close-btn h-4 w-4 border border-black mr-2 hover:invert hover:bg-white cursor-point"></div>
                                            <div className="flex-1 flex handle h-4 items-center">
                                                <div className="flex-1 flex flex-col justify-between cursor-grab h-2">
                                ...
                                <Draggable handle=".handle" onMouseDown={this.toggleWindowVisibility}>
                                    <div id='window-6' className="p-1 border border-black mt-4 bg-gray-mac shadow-mac-os os-window w-full mb-16 max-w-sm pointer-events-auto" style={this.state.windows[6].focused ? {zIndex: 99} : {zIndex:1}}>
                                        <div className="flex flex-row items-center pb-1">
                                            <div className="close-btn h-4 w-4 border border-black mr-2 hover:invert hover:bg-white cursor-point"></div>
                                            <div className="flex-1 flex handle h-4 items-center">
                                                <div className="flex-1 flex flex-col justify-between cursor-grab h-2">
